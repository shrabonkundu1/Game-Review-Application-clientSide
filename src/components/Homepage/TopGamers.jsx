...
const TopGamers = () => {
  return (
    <div className="mb-24 border rounded-lg p-16  mx-auto bg-gradient-to-r from-[#060c3b] to-[#010314]">
      <h1 className="text-center font-semibold text-5xl text-blue-300">Top 3 Gamers</h1>
      <div className="flex justify-between items-center w-[80%] mx-auto gap-8 mt-16">
        <div className="card  rounded-lg bg-[#1d232a] shadow-2xl w-max hover:border-2 hover:border-blue-300 hover:scale-105 ">
          ...
          <div className="card-body py-3 px-5 text-center space-y-2">
            ...
            <div className="card-actions py-3 flex justify-center items-center gap-8 text-3xl text-white">
              <a href="https://www.facebook.com/totalgaming093/"><FaFacebook /></a>
              <a href="https://www.youtube.com/@TotalGaming093"><IoLogoYoutube /></a>
             <a href="https://www.instagram.com/totalgaming_official/?hl=en"> <BsInstagram /></a>
            </div>
          </div>
        </div>
        <div className="card  rounded-lg bg-[#1d232a] shadow-xl w-max hover:border-2 hover:border-blue-300 hover:scale-105">
          ...
          <div className="card-body py-3 px-5 text-center space-y-2">
            ...
            <div className="card-actions py-3 flex justify-center items-center gap-8 text-3xl text-white">
            <a href="https://www.facebook.com/ohyeahhaming"><FaFacebook /></a>
              <a href="https://www.youtube.com/@ohyeahgaming6576"><IoLogoYoutube /></a>
             <a href="https://www.instagram.com/ohyeah_gaming/?hl=en"> <BsInstagram /></a>
            </div>
          </div>
        </div>
        <div className="card  rounded-lg bg-[#1d232a] shadow-xl w-max hover:border-2 hover:border-blue-300 hover:scale-105">
          ...
          <div className="card-body py-3 px-5 text-center space-y-2">
            ...
            <div className="card-actions py-3 flex justify-center items-center gap-8 text-3xl text-white">
            <a href="https://www.facebook.com/profile.php?id=100069241404652"><FaFacebook /></a>
              <a href="https://www.youtube.com/@OMGGAMING992"><IoLogoYoutube /></a>
             <a href="https://www.instagram.com/omg___gaming/?hl=en"> <BsInstagram /></a>
            </div>
          </div>
        </div>
      </div>
